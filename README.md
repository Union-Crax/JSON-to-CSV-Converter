...
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/Union-Crax/json2csv/pulls)
...
### Direct Download
```bash
git clone https://github.com/Union-Crax/json2csv.git
cd json2csv
chmod +x json2csv.py
```
